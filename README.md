...
Дисперсия шума ![a](http://latex.codecogs.com/gif.latex?%5Csigma%5E2%3D1), дисперсия угла наклона тренда $\sigma_a^2=0.25$, средняя частота смены тренда 1 раз за 200 точек ($\lambda = 200$).
